...
import { UserState, toggleThemeVal } from '@/store/redux/user';
              ...
              <Card style={[styles.card, { backgroundColor: currentTheme.colors.surface }]}>
                <Card.Content>
                  ...
                  <View style={styles.toggleTextContainer}>
                    <Text style={predictionType === 'daily' ? { ...styles.activeToggleText, color: currentTheme.colors.text } : { ...styles.inactiveToggleText, color: currentTheme.colors.placeholder }}>Daily</Text>
                    <Text style={predictionType === 'monthly' ? { ...styles.activeToggleText, color: currentTheme.colors.text } : { ...styles.inactiveToggleText, color: currentTheme.colors.placeholder }}>Monthly</Text>
                    <Text style={predictionType === 'yearly' ? { ...styles.activeToggleText, color: currentTheme.colors.text } : { ...styles.inactiveToggleText, color: currentTheme.colors.placeholder }}>Yearly</Text>
                  </View>
